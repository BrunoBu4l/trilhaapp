...
class _LoginPageState extends State<LoginPage> {
  ...
  //String email = "";
  //String senha = "";
  bool isObscureText = true; //variavel para mostrar/ocultar senha
  @override
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "Faça o seu login e make the change_",
              ...
              Container(
                ...
                child: TextField(
                  ...
                  obscureText: isObscureText, //deixa o texto
                  onChanged: (value) {
                    debugPrint(value);
                  },
                  style: const TextStyle(color: Colors.white),
                  ...
                  child: TextButton(
                      ...
                      style: ButtonStyle(
                          ...
                          backgroundColor: MaterialStateProperty.all(
                              const Color.fromARGB(255, 65, 32, 119))),
                      child: const Text(
                        "ENTRAR",
                        style: TextStyle(
                            color: Colors.white,
